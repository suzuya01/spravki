        ...
        <div id="block" class="absolute flex-col right-44 w-[400px] top-[215px] border py-2 rounded-lg bg-slate-200">
            <div class="flex items-center justify-center">
                ...
                <div class="">
                    ...
                    <div class="flex justify-center flex-wrap gap-3 h-[224px] overflow-y-auto py-1 px-2">
                        <h1 class="text-center text-slate-500 font-semibold text-sm">Пока что нет уже созданных справок</h1>
                        <?php
                            $dir = './spravki';
                            $files = scandir($dir);
                            foreach ($files as $key => $value) {
                                if($key > "1"){
                                    echo '<a href="./spravki/'.$value.'" download="'.$value.'" id="btn" target="_blank" class="text-sm text-slate-600 font-semibold rounded-[29px] bg-slate-300 w-[200px] py-0.5 text-center h-[44px] align-middle flex items-center justify-center">'.$value.'</a>';
                                }
                                else{
